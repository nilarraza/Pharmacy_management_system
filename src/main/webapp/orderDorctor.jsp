...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Page content -->
         ...
         <form   class="form-register"  class="form-register col-10" method="post" action="uploadDrOrder">
                    ...
                    <input type="text" name="ContactNo" class="form-control" placeholder="ContactNo" required autofocus><br>
                     <input type="text" name="Address" class="form-control" placeholder="Delivery Address" required autofocus><br>
                        <input type="email" class="form-control" placeholder="email" name="email"  required autofocus><br>
                         <input type="text" class="form-control" placeholder="Online Prescription" name="prescription"  required autofocus><br>                                          
