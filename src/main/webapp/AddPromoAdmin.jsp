...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Page content -->
      ...
      <form   class="form-register"  class="form-register col-10" method="post" action="/addPromotion">
             <fieldset class="border p-2"> 
                 
                 <legend  class="w-auto">Add Promo Code</legend>
                	
                                              
                     <input type="text" name="Promocode" class="form-control" placeholder="Add Promotion Code"><br>           
                 <input type="text" name="discountValue" class="form-control" placeholder="Add Discount value"><br> 
                 
                 <button type="submit" name="submit" class="btn btn-primary">Save</button><br><br>
               
                 
            </fieldset>
         </form>
          
        <a href="/deletePromotion" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Delete Promotion</a>
