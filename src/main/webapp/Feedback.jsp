...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Page content -->
		 ...
		 <form   class="form-register" name="form1"  class="form-register col-10" method="post" action="/sendFeedback" >
             <fieldset class="border p-2"> 
            
                 
                 <legend  class="w-auto">  Feedback</legend>
                	
                    
                      <input type="text"  name="textfee" class="form-control" placeholder="Feedback" required autofocus><br>                 
					<button type="submit"  name="submit"  class="btn btn-outline-primary btn-lg btn-block">Send Feedback </button><br><br>
