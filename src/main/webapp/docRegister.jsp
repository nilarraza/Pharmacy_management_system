...
<body class="text-center">
         ...
         <form  class="form-register"  class="form-register col-10" method="post" action="adddoctor">
             <fieldset class="border p-2"> 
                 
                 <legend  class="w-auto"> Professional Registration</legend>
                    ...
                    <input type="text" name="slmcNo" class="form-control" placeholder="Address" required autofocus><br>
                    ...
                    <input type="text"  name="password" class="form-control" placeholder="Password" required autofocus><br>
