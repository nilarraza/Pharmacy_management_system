...
<body class="text-center">
         ...
         <form   class="form-register" name="form1"  class="form-register col-10" method="post" action="updatePharmasist" >
             <fieldset class="border p-2"> 
                 ...
                 <legend  class="w-auto">  Edit Details</legend>
                    ...
                    <input type="text" name="dob" class="form-control" placeholder="dob" value="${user.dob}" required autofocus><br>                                      	 
                  	  ...
                  	  <input type="text" name="pharmaRegNo" class="form-control" placeholder="pharmaRegNo" value="${user.pharmaRegNo}" required autofocus><br>
