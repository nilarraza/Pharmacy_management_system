		...
		<tbody>
			<c:forEach var="drug" items="${drugs }">
				<tr>
					...
					<td><img src="./PresImg/${drug.path}" style="height: 50; width: 60" id="myImg"></td>
					<td><a  href="/sendConfirmationCr?id=${drug.user}"><i class="far fa-envelope"></a></td>
					<td><a  href="/sendCancelCr?id=${drug.user}&ido=${drug.orderId}"><i class="far fa-envelope"></a></td>
