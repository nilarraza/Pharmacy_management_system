	...
	<nav
		...
		<div class="container-fluid">
			...
			<a class="navbar-brand pt-0" href="./index.html"> <img
				src="./img/medixlogo.png" class="navbar-brand-img" alt="...">
			</a>
			<!-- User -->
					...
					aria-expanded="false">
						<div class="media align-items-center">
							<span class="avatar avatar-sm rounded-circle"> <img
								alt="Image placeholder" src="img/theme/team-1-800x800.jpg">
							</span>
						</div>
				</a>
					<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<div class="navbar-collapse-header d-md-none">
					<div class="row">
						<div class="col-6 collapse-brand">
							<a href="./index.html"> <img src="img/brand/blue.png">
							</a>
						</div>
				...
				<!-- Navigation -->
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link" href="/listCustomers">
							<i class="fas fa-users"></i>List Customers
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/listPharmasist"> <i class="fas fa-user-tie"></i>List
							Pharmasist
					</a></li>
					<li class="nav-item"><a class="nav-link" href="/listDoctors">
							<i class="fas fa-user-md"></i> List Doctors
					</a></li>


					<li class="nav-item"><a class="nav-link"
						href="/pharmRegister.jsp"> <i class="ni ni-tv-2 text-primary"></i>Add
							Pharmasist
					</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="/showOrdersAd">
							<i class="ni ni-bullet-list-67 text-red"></i>Customer Orders
					</a></li>

					<li class="nav-item"><a class="nav-link"
						href="/showDrOrdersAd"> <i
							class="ni ni-bullet-list-67 text-red"></i>Doctoer Orders
					</a></li>
					...
					<li class="nav-item"><a class="nav-link"
						href="/AddPromoAdmin.jsp"> <i
							class="ni ni-bullet-list-67 text-red"></i>Add Promo Code
					</a></li>

					<li class="nav-item"><a class="nav-link" href="/genReport">
							<i class="ni ni-bullet-list-67 text-red"></i> Generate Report
					</a></li>

					<li class="nav-item"><a class="nav-link"
						href="/AdminAddAdver.jsp"> <i
							class="ni ni-bullet-list-67 text-red"></i> Advertisement
					</a></li>

					<li class="nav-item"><a class="nav-link" href="/ShowFeedback">
							<i class="ni ni-bullet-list-67 text-red"></i> Feedback
					</a></li>

					<li class="nav-item"><a class="nav-link" href="/showSales">
				...
				<ul class="navbar-nav align-items-center d-none d-md-flex">
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						...
						aria-expanded="false">
							<div class="media align-items-center">
								<span class="avatar avatar-sm rounded-circle"> <img
									alt="Image placeholder" src="img/theme/team-4-800x800.jpg">
								</span>
						...
						<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
							...
							<div class="dropdown-divider"></div>
							<a href="/login" class="dropdown-item"> <i
					...
					<tbody>
						<c:forEach var="feedback" items="${feedback }">
							<tr>
								...
								<td>${feedback.date}</td>
								<td>${feedback.time}</td>
								<td><a href="/sendReply?id=${feedback.user_id}"><i
										class="fas fa-reply"></i></td>
