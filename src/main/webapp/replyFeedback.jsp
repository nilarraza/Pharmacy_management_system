...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Page content -->
		 <form   class="form-register" name="form1"  class="form-register col-10" method="post" action="/sendReplyFeedback" >
             <fieldset class="border p-2"> 
            
                 
                 <legend  class="w-auto">  Verify Order</legend>
                	<input type="text" class="form-control" placeholder="mail" name="mail" value="${replymail}" readonly required autofocus><br>          
                    <input type="text" class="form-control" placeholder="subject" name="subject" value="Feedback Reply From MEDIX"  readonly required autofocus><br>   
                     <input type="text" class="form-control" placeholder="content" name="content"    required autofocus><br>                 
					<button type="submit"  name="submit"  class="btn btn-outline-primary btn-lg btn-block">Send Reply via email </button><br><br>
