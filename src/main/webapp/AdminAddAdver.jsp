...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Page content -->
      ...
      <form   class="form-register"  class="form-register col-10" method="post" action="/addAdvertisement" enctype="multipart/form-data">
             <fieldset class="border p-2"> 
                 
                 <legend  class="w-auto">Add Advertisement</legend>
        ...
        <a href="/deleteAdvertisement" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Delete Advertisement</a>
